<?php
    $explanations = [
        ...
        "Le PHP est très permissif sur les types de variables, mais il est possible de forcer le type de variable en utilisant des 
        fonctions de conversion de type (les fonctions de casting).", 
